 ...
 * @class SocialFBSigninScenarioModel
 * @extends ScenarioModel
 */
class SocialFBSigninScenarioModel extends ScenarioModel {
  /**
   * Creates an instance of SocialFBSigninScenarioModel.
   ...
   * @async
   * @method
   * @memberof SocialFBSigninScenarioModel
   */
   ...
   * @memberof SocialFBSigninScenarioModel
   */
  socialFBSigninReturnUser = async () => {
  ...
  loginToAccount = async () => {
    ...
    const { accFBUsername, accFBPassword } = this.testData;
   ...
   * @async
   * @method
   * @memberof SocialFBigninScenarioModel
   */
...
module.exports = SocialFBSigninScenarioModel;
