# Guest User checkout for Manual offer product Mobile

## Guest User checkout for Manual offer product 
...
* UKRCO ENTER OFFERCODE
* UKRCO Click On Offer Button and Assert
