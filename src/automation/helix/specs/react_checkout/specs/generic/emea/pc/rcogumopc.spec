# Running RCO Guest User Manual Offer PC Test

## As a Guest User I would like to Apply Manual Offer and Complete Checkout for PC
...
* EMEARCO Verify that the user is able to Apply Valid OfferCode "PC"
