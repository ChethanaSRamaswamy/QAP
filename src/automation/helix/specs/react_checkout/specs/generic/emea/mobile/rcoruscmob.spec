# Running RCO Return User Saved Card Mobile Test

## As a Return User I would like to Add a Product and Complete Checkout with Saved Credit Card for Mobile
...
* EMEARCO Verify that the user is able to Login as Saved Card Return User Successfully "MOBILE"
