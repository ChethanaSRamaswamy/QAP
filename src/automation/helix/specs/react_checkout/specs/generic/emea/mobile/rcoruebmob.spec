# Running RCO Return User Edit Billing Mobile Test

## Return - Edit Shipping and Billing Address [Select any Saved Billing Address] and Place Order
...
* EMEARCO Verify that the user is able to Login as Return User successfully "MOBILE"
...
* EMEARCO Verify that the user is able to click on "ReturnUser" Continue to Payment Button successfully "MOBILE"
