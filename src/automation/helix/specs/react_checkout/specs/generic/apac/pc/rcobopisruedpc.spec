# Running RCO BOPIS Return User Edit Delivery PC Test 

## As a Return User I would like to edit the delivery option and checkout, validate order address for PC using BOPIS
...
* APACRCO Verify that user can Edit Delivery Option
* APACRCO Verify that user is able to Click Home Delivery
* APACRCO Verify that user can select delivery method
* APACRCO Verify that user is able to click shipping address continue button
