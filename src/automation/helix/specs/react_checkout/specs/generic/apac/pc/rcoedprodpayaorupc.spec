# Running RCO Return User with Auto offer PC Test 

## As a Return user I would like to edit product from Payment Page and checkout again with Auto Offers for PC
...
* APACRCO Verify that user is able to edit product from "Payment" checkout pages
