# Running RCO Return User Edit Product Mobile Test with 3DS1 Payment

## As a Return user I would like to edit product from Delivery Page and checkout with 3DS1 Payment for Mobile
...
* APACRCO Verify that user is able to edit product from "Delivery" checkout pages
...
* APACRCO Verify that user is able to select Credit card radio button and enter Credit Card Details "DS1"
