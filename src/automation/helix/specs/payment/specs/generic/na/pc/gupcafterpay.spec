# Running AfterPay Guest User PC Test 


## As a Guest User i would like to Add a product and complete checkout for PC by AfterPay Method
* NAACCCHK Initialize Helix
* NAPAYMENT Initialize Helix
