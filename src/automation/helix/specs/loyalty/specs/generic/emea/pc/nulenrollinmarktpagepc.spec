# New user Enroll into Loaylty from Marketing page PC test
...
* EMEALOYALTY Click on Join Loyalty in Footer
* EMEALOYALTY Click on Join Now Button
* EMEALOYALTY Click on Login Button in Acc page
* EMEALOYALTY Account Register Now
* EMEALOYALTY Register EmailId and Submit
