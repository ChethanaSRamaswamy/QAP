# NU Welcome and Birthday offer validation MOB test 
...
* EMEALOYALTY Click logIn btn/link
* EMEALOYALTY Account Register Now
* EMEALOYALTY Account Register Now1
* EMEALOYALTY Account Register EmailId
...
* EMEALOYALTY Navigate to loyalty index page
* EMEALOYALTY Click on rewards section
* EMEALOYALTY Click on welcome reward redeem button
* EMEALOYALTY Click on Gnav Cart button
* EMEALOYALTY Navigate to offer manager
* EMEALOYALTY Verify welcome offer
* EMEALOYALTY Navigate to view cart page
* EMEALOYALTY Get purchase amount Mob
* EMEALOYALTY Click expand button in view cart page
* EMEALOYALTY verify loyalty point in view cart page
...
* EMEALOYALTY Navigate to loyalty index page
* EMEALOYALTY Click on rewards section
* EMEALOYALTY Click on Birthday reward redeem button
* EMEALOYALTY Click on Gnav Cart button
* EMEALOYALTY Navigate to offer manager
* EMEALOYALTY Verify birthday offer
* EMEALOYALTY Navigate to view cart page
* EMEALOYALTY Get purchase amount Mob
* EMEALOYALTY Click expand button in view cart page
* EMEALOYALTY verify loyalty point in view cart page
* EMEALOYALTY Verify loyalty offer code panel 
* EMEALOYALTY Click checkout btn and proceed to Sample/SignIn page
* EMEALOYALTY Click sample continue button/link
* EMEALOYALTY click shipping address continue
* EMEALOYALTY select payment method radiobutton
