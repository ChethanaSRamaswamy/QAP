# LU Reward redemption validation MOB test 


## Verify whether the Loyalty user can redeem point rewards (DEV & STAGE)
* NALOYALTY Initialize Helix 
* NALOYALTY Set cookies,rev tag,test order flag
