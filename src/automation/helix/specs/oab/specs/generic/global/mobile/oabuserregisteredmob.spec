# OAB MOBILE OABUSERREGISTEREDMOB

## Book OAB appointment as a registered user
...
Assert if deails were correctly transerred to AppHQ for registered guest user OAB
