# OAB PC HQACLSUPERADMINISTRATORPC
* OAB AppHQ Initialize Helix
* OAB AppHQ Go to Appointment HQ page
PRECONDTIONS:
Superadministrator is assigned to all brands by ALL button
Superadministrator is assigned to all regions by ALL button
Superadministrator is assigned to all stores
KNOWN ISSUES:
https://jira.esteeonline.com/browse/OABHQ-2681 

## Superadministrator flow check.
* OAB AppHQ Log in into Appointment HQ as "superadministrator" with "api"
...
* OAB AppHQ Click back to settings icon
* OAB AppHQ Go to Global "visible"
* OAB AppHQ Click back to settings icon
* OAB AppHQ Go to Datafeeds "visible"
* OAB AppHQ Go to About "visible"
* OAB AppHQ Log out from Appointment HQ

## Check if superadministrator can manage appointments creation. Verify if can mark as test appointment and can trigger test emails.
...
## Check if superadministrator can create/update/archive/reactivate/delete schedules stores.
* OAB AppHQ Log in into Appointment HQ as "superadministrator" with "noapi"
* OAB AppHQ Select brand, country and "Test OAB" store
* OAB AppHQ Click "Settings" from footer "visible"
* OAB AppHQ Go to Stores "visible"
...
## Check if superadministrator can create/update/archive/reactivate/delete services and categories.
...
## Check if superadministrator can manage all users.
* OAB AppHQ Log in into Appointment HQ as "superadministrator" with "noapi"
* OAB AppHQ Click "Settings" from footer "visible"
* OAB AppHQ Go to Users "visible"
* OAB AppHQ Click add new "User" "visible"
* OAB AppHQ Check which type of user "superadministrator" can create
* OAB AppHQ Enter user details "superadministrator"
...
* OAB AppHQ Search for "brandadmin" "User"
* OAB AppHQ Open kebab menu "visible" "specific"
* OAB AppHQ Open modal from list "visible"
* OAB AppHQ Close modal window
* OAB AppHQ Open kebab menu "visible" "specific"
