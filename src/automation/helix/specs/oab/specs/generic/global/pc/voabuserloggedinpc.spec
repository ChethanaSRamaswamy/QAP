# VOAB PC VOABUSERLOGGEDINPC

## Book VOAB appointment as a logged in user
...
Assert if deails were correctly transerred to AppHQ for logged in user VOAB
...
Assert if deails were correctly transerred to My Appointments for logged in user VOAB
