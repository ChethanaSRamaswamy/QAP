# Running ROM Guest User PC EXPPaypal Test 

   |set_no|
   |------|
   |0     |

## As a ROM Guest User i would like to Add a product and complete checkout for PC by Express Paypal
* ROM Initialize Helix <set_no>
* ROM Set BrandLocale variables 
* ROM Set Cookies 
* ROM Test Gift Wrap Flag Url
