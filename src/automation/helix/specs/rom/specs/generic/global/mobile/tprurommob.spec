# Running ROM Three Product Return User Mobile Test 

     |set_no|
     |------|
     |0     |

## As a ROM Return User i would like to Add a Three Product and complete checkout for MOBILE
* ROM Initialize Helix <set_no>
* ROM Mobile Device Emulation
* ROM Set BrandLocale variables 
* ROM Set Cookies 
* ROM Three Product Add to the cart 
