# Running ROM Mltiple Product Return User Mobile Test Paypal

     |set_no|
     |------|
     |0     |

## As a ROM Return User i would like to Add a Mltiple Product product and complete checkout for MOBILE by Paypal
