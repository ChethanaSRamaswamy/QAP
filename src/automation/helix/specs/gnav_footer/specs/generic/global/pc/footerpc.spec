# Footer scenario's for PC.

## Visit the Home page, scroll to Footer section and verify the Subsection and respective links and copyrights and click on live chat if available.
...
* GNAVFOOTER Verify the Livechat exists in the Footer
...
## Visit the Home page, scroll to Footer section and select country in the Location Dropdown and validate if available.
* GNAVFOOTER Initialize Helix
Test set up for executing the scenario :
* GNAVFOOTER Configuring the prerequisites like set cookies, revision tag
* GNAVFOOTER Open Home Page and Choose Country & Language in case of hubsites
