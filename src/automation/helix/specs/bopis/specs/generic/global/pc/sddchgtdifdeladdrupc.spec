...
## SDD-PC-TC12 SDDChgTDifDelAddRUPC Verify whether a Return User is able to select a different delivery address (from address 1 to address 2) and place SDD successfully.
...
* BOPIS Return User Email Id "test0005@yopmail.com"
