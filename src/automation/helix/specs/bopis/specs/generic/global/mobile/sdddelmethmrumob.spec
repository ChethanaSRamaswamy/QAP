...
## SDD-MOB-TC17 SDDDelMetHmRUMOB Verify whether a Return User is able to change delivery method to Home Delivery and place a Regular order.
...
* BOPIS Return User Email Id "test7093@yopmail.com"
...
* BOPIS User clicks Same Day Delivery and selects Select Home Delivery And Continue in pop-up
* BOPIS MOB Click On Order Review Details Continue Button and Proceed to Payment Page
* BOPIS Select keep this address popup option
