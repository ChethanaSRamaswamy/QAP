# Mobile MPPSORTFILTERFAQ MPP Scenarios

For AV Global Sorting is not Working:https://jira.esteeonline.com/browse/ASMBLY4-1392

## Visit the homepage and go to MPP and check the sorting and filtering options top-down and bottom-up in MPP.
