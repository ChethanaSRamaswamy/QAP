# Bag icon check on MPP and SPP for MOBILE. 

## Visit the Home page, go to MPP, click on Quick View and navigate to SPP. And add the product to the bag and check if the bag icon exists or not and check the product added to the cart page.
