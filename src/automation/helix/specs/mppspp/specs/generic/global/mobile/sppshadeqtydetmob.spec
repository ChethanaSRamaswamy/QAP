# Mobile SPPSHADEQTYDET SPP Scenarios

## Visit the homepage and click on the product view on MPP and choose shading, increase/decrease quantity in SPP until cart validation. Check all the details section, validate the expand and collapse product details section.
...
* MPPSPP Verify details section on spp