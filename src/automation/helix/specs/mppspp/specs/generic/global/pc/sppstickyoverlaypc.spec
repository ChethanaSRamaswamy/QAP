# PC SPPSTICKYOVERLAY SPP Scenarios

## Visit the home page, go to any SPP and choose shade or size in the sticky overlay section and add it to cart and validate the same in cartpage.
