#  Validating the Live Chat feature in home page Mobile

## Validating the Live Chat feature in Home page
* LCD Initialize Helix
* LCD Mobile Device Emulation
* LCD Configuring the prerequisites like set cookies, revision tag
* LCD Verify that the user is able to navigate to web page for "HOME"
* LCD Verify that the user is able to close the popup
