# Running Return User Edit Mobile Test by AR

## As a Return User i would like to Add an AR product and complete checkout for MOBILE and edit details
* AUTOREPLENISHMENT Initialize Helix
