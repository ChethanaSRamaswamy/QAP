...
* GA Analytics validation
* APACACCCHK Verify that the user is able to proceed to "Guestuser" Sign in successfully
* GA Analytics validation
* APACACCCHK Verify that the user is able to enter the "Guestuser" shipping details successfully
* GA Analytics validation
