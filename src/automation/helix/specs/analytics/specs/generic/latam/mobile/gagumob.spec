...
## AS a Guest User i would like to Add a product and complete checkout for MOBILE.
...
* GA Analytics validation
* LATMACCCHK Verify that user is able to Continue checkout as "Guest user"
* GA Analytics validation
* LATMACCCHK Verify that the user is able to enter the shipping details for "Guest user"
* GA Analytics validation
* LATMACCCHK Verify that the user is able to select the payment method
* GA Analytics validation
* LATMACCCHK Verify that the user is able to place the order as "Guest user"
* GA Analytics validation
