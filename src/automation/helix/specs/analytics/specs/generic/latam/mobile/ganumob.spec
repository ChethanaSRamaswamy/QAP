...
* GA Analytics validation
* LATMACCCHK Verify that user is able to Continue checkout as "New user"
* GA Analytics validation
* LATMACCCHK Verify that the user is able to enter the shipping details for "New user"
* GA Analytics validation
* LATMACCCHK Verify that the user is able to select the payment method
* GA Analytics validation
* LATMACCCHK Verify that the user is able to place the order as "New user"
* GA Analytics validation
