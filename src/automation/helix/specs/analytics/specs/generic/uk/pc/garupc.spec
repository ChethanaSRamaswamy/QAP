...
## As a Return User i would like to Add a product and complete checkout for PC.
...
* GA Analytics validation
* UKACCCHK Verify that the user is able to select the payment method successfully "RU"
* GA Analytics validation
