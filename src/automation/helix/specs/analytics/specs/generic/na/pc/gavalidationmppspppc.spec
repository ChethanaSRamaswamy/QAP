# Sanity check around MPP and SPP for PC

## Visit the Home page, go to MPP, click on Quick View and navigate to SPP. And add the product to the bag and check if the basket overlay exists or not and check the product added to the cart page.
